...
<template>
    ...
    <div class="container mx-auto px-5">
        <header class="flex justify-between py-12 items-center">
            <div>
                <a href="/"><img src="/images/teoh_logo_black.png" alt="Site Logo"></a>
            </div>
            ...
            <nav class="flex justify-end flex-col md:flex-row">
                ...
                <ul class="space-x-10 font-theme-heading font-medium items-center hidden md:flex  flex-col space-y-7 md:space-y-0 md:flex-row">
                    <li class="uppercase hover:text-theme-secondary transition duration-200"><RouterLink to="/blog">Blog</RouterLink></li>
                    <li class="uppercase hover:text-theme-secondary transition duration-200"><RouterLink to="/casos">Casos</RouterLink></li>
                    <li class="uppercase hover:text-theme-secondary transition duration-200"><RouterLink to="/login">Tienda</RouterLink></li>
