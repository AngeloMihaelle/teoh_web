...
<template>
    ...
    <div class="container mx-auto px-5">
        <header class="flex justify-between py-12 items-center">
            <div>
                <a href="/"><img src="/images/TEOH_admin.png" alt="Site Logo"></a>
            </div>
            ...
            <nav class="flex justify-end flex-col md:flex-row">
                ...
                <ul class="space-x-10 font-theme-heading font-medium items-center hidden md:flex  flex-col space-y-7 md:space-y-0 md:flex-row">
                    <li class="uppercase hover:text-theme-secondary transition duration-200"><RouterLink to="/admin/blog">Blog</RouterLink></li>
                    <li class="uppercase hover:text-theme-secondary transition duration-200"><RouterLink to="/admin/casos">Casos</RouterLink></li>
                    <li class="uppercase hover:text-theme-secondary transition duration-200"><RouterLink to="/admin/productos">Productos</RouterLink></li>
                    <li class="uppercase hover:text-theme-secondary transition duration-200"><RouterLink to="/admin/pedidos">Pedidos</RouterLink></li>
                    <li class="uppercase hover:text-theme-secondary transition duration-200"><RouterLink to="/admin/usuarios">Usuarios</RouterLink></li>
