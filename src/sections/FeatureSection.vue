    ...
    <div id="features" class="container mx-auto px-5">
        <section class="py-16">
            <div class="w-4/5 md:w-3/5 mx-auto">
                <h2 class="text-3xl md:text-4xl font-semibold font-theme-heading text-center">¿Quienes somos?</h2>
                <p class="text-theme-grayish-blue text-center mt-7 font-theme-content text-lg">Somos un equipo experto y garantizado. Ofrecemos los mejores servicios en nuestro campo heridas-ostomías-estomas. Nunca escatimamos ningún esfuerzo para logarlo, y lograr satisfacerle a usted siempre es nuestra máxima prioridad. Eso es lo que somos, lo cual nos enorgullece.</p>
            </div>
